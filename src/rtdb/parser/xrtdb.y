...
int main(int argc, char *argv[])
{
        ...
        int userFileStatus, rtdb2ConfigFileStatus;
        ...
        rtdb2ConfigFileStatus = printRtDB2File(agList, assignList);
        switch (rtdb2ConfigFileStatus)
        {
                case 0: {
                        printf("\nFicheiro \e[32mrtdb2_configuration.xml\e[0m criado com sucesso!\n");
                        break;
                        }
                case 1: {
                        printf("\nCriação do ficheiro \e[32mrtdb2_configuration.xml\e[0m cancelada pelo utilizador.\n");
                        break;
                        }
                case 2: {
                        printf("\n\e[33mERRO\e[0m a criar o ficheiro \e[32mrtdb2_configuration.xml\e[0m. Não foi possível abrir o ficheiro para escrita.\n");
                        break;
                        }
                default: printf("\n\e[33mERRO\e[0m inesperado a criar o ficheiro \e[32mrtdb2_configuration.xml\e[0m!\n");
        }
